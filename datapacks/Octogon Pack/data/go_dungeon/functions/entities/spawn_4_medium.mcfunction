...
execute if score number RNG_77 matches 3 run scoreboard players set SpawnMob DungeonEvents 4
execute if score number RNG_77 matches 4 run scoreboard players set SpawnMob DungeonEvents 5

function go_dungeon:entities/summon_4_medium
