...
scoreboard players set max RNG_77 20
...
execute if score Room DungeonRandom matches 3..5 run function go_dungeon:place/hallway/intersection/place_intersection
execute if score Room DungeonRandom matches 6..8 run function go_dungeon:place/stairs/place_stairs
execute if score Room DungeonRandom matches 9..13 run function go_dungeon:place/hallway/straight/place_hallway
execute if score Room DungeonRandom matches 14..20 run function go_dungeon:place/rolls/roll_other_room_2
...
execute if score @s DungeonCollisions matches 1 unless score PlacementTries DungeonEvents >= MaxPlacementTries DungeonSettings run function go_dungeon:place/rolls/roll_random_room_2
