...
execute if score Room DungeonRandom matches 3..6 run function go_dungeon:place/hallway/intersection/place_intersection
execute if score Room DungeonRandom matches 7..8 run function go_dungeon:place/stairs/place_stairs
execute if score Room DungeonRandom matches 9..15 run function go_dungeon:place/hallway/straight/place_hallway
execute if score Room DungeonRandom matches 16..19 run function go_dungeon:place/rolls/roll_other_room
...
execute if score @s DungeonCollisions matches 1 unless score PlacementTries DungeonEvents >= MaxPlacementTries DungeonSettings run function go_dungeon:place/rolls/roll_random_room
