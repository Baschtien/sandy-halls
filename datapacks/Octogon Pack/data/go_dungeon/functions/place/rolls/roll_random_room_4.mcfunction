...
scoreboard players set max RNG_77 21
...
execute if score Room DungeonRandom matches 8..13 run function go_dungeon:place/hallway/straight/place_hallway
execute if score Room DungeonRandom matches 14..21 run function go_dungeon:place/rolls/roll_other_room_4
...
execute if score @s DungeonCollisions matches 1 unless score PlacementTries DungeonEvents >= MaxPlacementTries DungeonSettings run function go_dungeon:place/rolls/roll_random_room_4
