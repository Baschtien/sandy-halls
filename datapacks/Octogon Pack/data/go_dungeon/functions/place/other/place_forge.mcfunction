...
execute positioned ^-6 ^ ^2 facing ^-1 ^ ^ run function go_dungeon:check/check_5_5
execute positioned ^-6 ^ ^7 facing ^-1 ^ ^ run function go_dungeon:check/check_5_5
execute if score CollisionsEnabled DungeonSettings matches 0 run scoreboard players set @s DungeonCollisions 0

execute unless score @s DungeonCollisions matches 1 run function go_dungeon:place/other/place_forge_cnf
