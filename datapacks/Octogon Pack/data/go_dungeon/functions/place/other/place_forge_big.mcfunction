...
execute if score @s DungeonFloors = MinFloor DungeonFloors run scoreboard players set @s DungeonCollisions 1
...
execute unless score @s DungeonCollisions matches 1 run function go_dungeon:place/other/place_forge_big_cnf
